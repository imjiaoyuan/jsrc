...
_NN_DH: dict[str, float] = {
    ...
    "GC": -9.8, "GG": -8.0, "AC": -7.8, "TG": -8.5,
    "AG": -7.8, "TC": -8.2, "TT": -7.9, "CC": -8.0,
}
_NN_DS: dict[str, float] = {
    "AA": -22.2, "AT": -20.4, "TA": -21.3, "CA": -22.7,
    "GT": -22.4, "CT": -21.0, "GA": -22.2, "CG": -27.2,
    "GC": -24.4, "GG": -19.9, "AC": -21.0, "TG": -22.7,
    "AG": -21.0, "TC": -22.2, "TT": -22.2, "CC": -19.9,
}
_R = 1.987
...
def cmd(args: Namespace) -> None:
    ...
    for r in results:
        print(f"{r['id']}\t{r['length']}\t{r['gc_percent']}\t"
...
def register(subparsers: Any) -> None:
    ...
    p.add_argument("--conc", type=float, default=250.0,
